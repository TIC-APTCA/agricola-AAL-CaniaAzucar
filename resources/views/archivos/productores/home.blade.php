...
<div class="tab-content">
		...
		<div class="row" >
			...
			<div class="float-right">
				<a href="{{ asset('/productores/registrar') }}" class="btn btn-primary btn-md" >Nuevo</a>
			</div>
		</div>
	...
	<div class="col-sm-4">
			<div class="chat-panel panel panel-default">
				<a href="{{ asset("productores/actualizar/$productor->id") }}" class="btn btn-info chat-heading" role="button">
